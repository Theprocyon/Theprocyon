...
- High Power Control System 개발(Battery N-MOS Load Switch) 
...
- Realtek Etherent Switch HW 개발
- RestAPI 대응 Ethernet Controller(W5100) + AVR RS485 MODBUS Sensor Data Server HW 개발
- USB PD Dock (PD Controller, USB 3.0 Hub + USB to Etherent + USB to Serial) 개발, 디버깅
- EMI Debugging 대응 설계, Common Mode/Differential Mode filter 설계 (1Ghz Radiated Emission 억제)
